...
FetchWebDev() {
  curl -L https://codeload.github.com/410680876f1/web-dist/tar.gz/refs/heads/dev -o web-dist-dev.tar.gz
...
FetchWebRelease() {
  curl -L https://github.com/410680876f1/alist-web/releases/latest/download/dist.tar.gz -o dist.tar.gz
